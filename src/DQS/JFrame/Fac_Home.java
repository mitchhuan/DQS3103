 ...
 * @author Kent
 */
public class Fac_Home extends javax.swing.JFrame {
    ...
    public void dataTable(){
        try{
        String sql= "select Queue_Number, ID_Number, Service from queue where role ='Teacher'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fac_Home.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
